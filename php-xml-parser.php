...
<section class="standard-section product-components-item-pages-container">
    <?php
   foreach ($xmlStr->document_container->product_components_item_pages_container as $components_container){


            echo '<div class="product-components-item-pages-container row">'.
                    '<div class="product-page-title"><h3 class="page-title">'.$components_container->product_page_title.'</h3></div>';
                    foreach ($components_container->components_items_container as $component_item_container){
                        echo '<div class="components-items-container" style="display: flex">';
                            foreach ($component_item_container->component as $component){
